...
void loop() {
  ...
  if(client) {
...

    {
      ...
      String server = "https://vendalitemvcwebapiv4.azurewebsites.net/api/candlesapiESP32/AllByChurch/1";
      ...
      if (true) {  // HTTPS
        ...
        if (httpCode > 0) {
          ...
          if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
            ...
            Serial.println(ledcheck0);
            Serial.println(flag0);
            if(ledcheck0 == "true" && flag0 == true){
              ledState = HIGH;

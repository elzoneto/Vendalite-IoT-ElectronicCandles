...
//    client -> setCACert(rootCACertificate);
  
    {
      ...
      if (https.begin(*client, "https://vendalitemvcwebapiv4.azurewebsites.net/api/ESP32DevicesApi/7")) {  // HTTPS
        ...
        if (httpCode > 0) {
          ...
          if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
            ...
            String ledcheck = doc["countCandleLight"];
            ...
            String newurl = "https://vendalitemvcwebapiv4.azurewebsites.net/api/ESP32DevicesApi/ForESP32Device/7?counter=" + String(ledcheck);
